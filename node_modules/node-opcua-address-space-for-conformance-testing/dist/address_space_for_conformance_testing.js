...
function validate_value_or_array(isArray, variantValue, validatorFunc) {
    node_opcua_assert_1.assert(_.isFunction(validatorFunc));
    let i;
    let value;
    if (isArray) {
...
function add_analog_data_items(namespace, parentFolder) {
    ...
    function _addAnalogDataItem(localParentFolder, dataType, initialValue) {
        ...
        node_opcua_assert_1.assert(_.isArray(initialValue) || (initialValue >= engineeringUnitsRange.low && initialValue <= engineeringUnitsRange.high));
...
function add_ObjectWithMethod(namespace, parentFolder) {
    ...
    node_opcua_assert_1.assert(node_opcua_nodeid_1.makeNodeId("MethodNoArgs", namespace.index).toString().match(/s=MethodNoArgs/));
...
function build_address_space_for_conformance_testing(addressSpace, options) {
    ...
    node_opcua_address_space_1.add_eventGeneratorObject(namespace, simulationFolder);
