...
import { AddReferenceOpts, AddressSpace, BaseNode as BaseNodePublic, UADataType, UAView, SessionContext, ContinuationPoint } from "../source";
...
export interface AddressSpacePrivate extends AddressSpace {
    ...
    _readProcessedDetails?: (variable: UAVariable, context: SessionContext, historyReadDetails: ReadProcessedDetails, indexRange: NumericRange | null, dataEncoding: QualifiedNameLike | null, continuationPoint: ContinuationPoint | null, callback: CallbackT<HistoryReadResult>) => void;
}
